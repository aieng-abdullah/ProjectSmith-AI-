...
```
You:           I want to build an app where farmers sell directly to customers

ProjectSmith:  What stops a farmer from just using WhatsApp groups they already have?

You:           Because they lose 40% to middlemen and we only take 5%

ProjectSmith:  What concrete evidence do you have that a farmer would move platforms for that?

You:           I talked to 5 farmers and they all said yes

ProjectSmith:  Tell me about one of those conversations in detail...

You:           plan it

ProjectSmith:  Generating plan... cost... edge cases... project brief...
```
